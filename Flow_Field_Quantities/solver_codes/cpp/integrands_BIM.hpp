 ...
 *
 * Description:
 * Contains the integrands of the boundary integrals equations. The discretized
 * integrals consider a linear evolution of the potential and normal velocities
 * along the segments separating two adjacent nodes. On the other hand the the
 * shape of the bubble and fluid-fluid interface is represented by cubic splines.
 *
 * -----------------------------------------------------------------------------
